...
public class NPC_Sad_ReactionThankState : NPC_Simple_State
{
    public NPC_Sad_ReactionThankState(NPC_Simple npc, NPC_Simple_StateMachine machine) : base(npc, machine) { }
